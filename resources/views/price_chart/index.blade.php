...
<head>
    ...
    <style>
        ...
        .tab-btn {
            ...
            cursor: pointer; font-size: 15px; background: #ddd; color: #555;
        }
        ...
        .legend { display: flex; gap: 20px; margin-bottom: 8px; font-size: 13px; }
        .legend-dot { width: 14px; height: 14px; border-radius: 50%; display: inline-block; margin-right: 4px; vertical-align: middle; }
        @if(session('success'))
        ...
        <form action="/price-chart/store" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="white_duck_usd" step="0.01" placeholder="例：5.50" required>
                </div>
